  ...
  _createClass(Carousel, [{
    ...
    value: function getSlideHeight(props) {
      ...
      if (heightMode === 'aspectRatio') {
        return firstSlide.offsetWidth * aspectRatio;
      }
    ...
    value: function setDimensions(props) {
      ...
      this.setState({
        ...
        var slideHeight = _this7.getSlideHeight(props, childNodes);

        if (slideHeight !== _this7.state.slideHeight) {
          _this7.setState({
            slideHeight: slideHeight
          });
        }
...
Carousel.propTypes = {
  ...
  heightMode: _propTypes.default.oneOf(['first', 'current', 'max', 'aspectRatio']),
